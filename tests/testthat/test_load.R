...
test_that("Various data classes can be loaded", {
    expect_is(inzightts(ts(1:10)), "inz_ts")
    expect_is(inzightts(visitorsQ), "inz_ts")
    expect_is(inzightts(visitorsQ, index = 1, var = 2), "inz_ts")
    expect_is(inzightts(visitorsQ, start = c(1998, 4), freq = 4), "inz_ts")
    expect_is(inzightts(visitorsQ, start = 1, end = nrow(visitorsQ)), "inz_ts")
    expect_is(inzightts(visitorsQ, freq = 4, end = c(2012, 1)), "inz_ts")
